...
const initialState: SynthesisState = {
    ...
    params: {
        ...
        envParams: [
            { type: 'Attack', id: 'a', min: 0, max: 2, step: 0, values: [0.1], selected: false}, // attack -> 起音
            { type: 'Decay', id: 'd', min: 0, max: 1, step: 0, values: [0.2], selected: false}, // decay -> 衰减
            { type: 'Sustain', id: 's', min: 0, max: 1, step: 0, values: [0.5], selected: false}, // sustain -> 维持
            { type: 'Release', id: 'r', min: 0, max: 4, step: 0, values: [1], selected: false }  // release -> 释放
        ],
        modEnvParams: [
            { type: 'Attack', id: 'moda', min: 0, max: 2, step: 0, values: [0], selected: false}, // attack -> 起音
            { type: 'Decay', id: 'modd', min: 0, max: 1, step: 0, values: [0.2], selected: false}, // decay -> 衰减
            { type: 'Sustain', id: 'mods', min: 0, max: 1, step: 0, values: [0.5], selected: false}, // sustain -> 维持
            { type: 'Release', id: 'modr', min: 0, max: 4, step: 0, values: [1], selected: false } // release -> 释放
        ],
        globalParams: [
            { type: 'Volume', id: 'volume', min: 0, max: 4, step: 0, values: [0.5], selected: false} // volume -> 音量
        ]
